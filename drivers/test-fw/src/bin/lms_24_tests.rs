...
const fn bytes_to_words(bytes: [u8; 24]) -> [U32<LittleEndian>; 6] {
...
fn test_hash_message_24() {
    ...
    let nonce: [U32<LittleEndian>; 6] = bytes_to_words([
