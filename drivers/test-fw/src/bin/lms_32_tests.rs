...
const fn bytes_to_words(bytes: [u8; 32]) -> [U32<LittleEndian>; 8] {
...
fn test_hash_message_32() {
    ...
    const FINAL_C: [U32<LittleEndian>; 8] = bytes_to_words([
...
fn test_lms_lower_32() {
    ...
    const LMS_PUBLIC_HASH: [U32<LittleEndian>; 8] = bytes_to_words([
...
fn test_hss_upper_32() {
    ...
    const HSS_PUBLIC_HASH: [U32<LittleEndian>; 8] = bytes_to_words([
    ...
    const UPPER_NONCE: [U32<LittleEndian>; 8] = bytes_to_words([
